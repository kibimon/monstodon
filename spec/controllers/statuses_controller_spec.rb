  ...
  describe '#show' do
    context 'account is suspended' do
      it 'returns gone' do
        ...
        get :show, params: { account_type: 'v1_trainer', account_username: account.username, id: status.id }
    ...
    context 'status is not permitted' do
      it 'raises ActiveRecord::RecordNotFound' do
        ...
        sign_in(user)
        get :show, params: { account_type: 'v1_trainer', account_username: status.account.username, id: status.id }
