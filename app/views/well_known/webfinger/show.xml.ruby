Nokogiri::XML::Builder.new do |xml|
  xml.XRD(xmlns: 'http://docs.oasis-open.org/ns/xri/xrd-1.0') do
    ...
    xml.Link(rel: 'http://schemas.google.com/g/2010#updates-from', type: 'application/atom+xml', href: OStatus::TagManager.uri_for(@account, format: 'atom'))
    xml.Link(rel: 'self', type: 'application/activity+json', href: ActivityPub::TagManager.uri_for(@account))
